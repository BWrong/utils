/* libName: authTool version: 1.3.3 author: bwrong<ibwrong@foxmail.com> */
/**
 * 注册权限指令
...
function _addPathOfMenus(routeMap, menus, authKey) {
    ...
    return menus.map(function (item) {
        var _a, _b;
        item.url = item.path = item.url || (item[authKey] && ((_a = routeMap[item[authKey]]) === null || _a === void 0 ? void 0 : _a.path)) || '';
