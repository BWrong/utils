  ...
  install: function install(Vue) {
    ...
    Vue.directive(directiveName, {
      ...
      mounted: function mounted(el, binding) {
        ...
        !hasAuth(binding.value) && ((_el$parentNode2 = el.parentNode) === null || _el$parentNode2 === void 0 ? void 0 : _el$parentNode2.removeChild(el));
      }
    });
  }
};
...
function _addPathOfMenus() {
  ...
  return menus.map(function (item) {
    ...
    item.url = item.path = item[authKey] && ((_routeMap$item$authKe = routeMap[item[authKey]]) === null || _routeMap$item$authKe === void 0 ? void 0 : _routeMap$item$authKe.path) || '';
